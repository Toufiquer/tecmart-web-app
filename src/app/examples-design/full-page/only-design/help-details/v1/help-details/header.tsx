...
import CardBox from "./detail-card";
      ...
      <div className="text-center">
        <div className="">
          <div className="flex w-full items-center justify-center">
            <div className="help-details-bg-img mb-12 h-[580px] w-[1100px] rounded-3xl">
              <div className=" h-full w-full rounded-3xl backdrop-blur">
                <div className="pt-32">
                  <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mx-auto mt-6 flex w-full max-w-[580px] flex-wrap justify-center gap-4 gap-y-6 font-bold [&>*:last-child]:no-underline [&>*]:text-[1rem] [&>*]:underline [&>*]:shadow-md">
