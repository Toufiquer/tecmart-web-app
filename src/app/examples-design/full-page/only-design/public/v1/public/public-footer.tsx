/*
|-----------------------------------------
| setting up PublicFooter for the App
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center">
        ...
        <div className="flex w-full flex-col items-start justify-between gap-4 border-t py-4 md:flex-row md:items-center">
          <div className="flex h-auto items-center justify-start gap-4">
            ...
            <Image
              src="https://i.ibb.co/YWYchGk/amazonpay.png"
              width={100}
              height={100}
              alt="Sign in"
            ...
            />
            <Image
              src="https://i.ibb.co/Fhjmzxy/american-express.png"
              width={100}
              height={100}
              alt="Sign in"
              className="h-auto w-[35px]"
            />
            <Image
              src="https://i.ibb.co/jVQX8RN/mastercard.png"
              width={100}
              height={100}
              alt="Sign in"
              className="h-auto w-[35px]"
          ...
          <div className="flex h-auto items-center justify-end gap-4">
            ...
            <Image
              src="https://i.ibb.co/K0wmb8Z/appstore-btn.png"
              width={100}
              height={100}
              alt="Sign in"
            ...
            />
            <Image
              src="https://i.ibb.co/k1svBvr/googleplay-btn.png"
              width={100}
              height={100}
              alt="Sign in"
              className="h-auto w-[100px]"
        ...
        <div className="flex w-full flex-col items-start justify-between gap-4 border-t py-4 text-xs md:flex-row md:items-center">
          <p className=" text-slate-500">
            ...
            reserved. Powered by{" "}
            <span className="font-semibold text-green-500">DaaUK</span>.
          </p>
