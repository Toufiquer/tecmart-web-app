      ...
      <div className="py-4">
        <div className="pt-1">
          ...
          <p className="py-2 text-slate-600">
            Thanks for using our products and services (&ldquo;Services&ldquo;).
            The Services are provided by Pixeel Ltd. (&ldquo;Space&ldquo;),
        ...
        <div className="pt-1">
          <h2 className="mt-6 text-xl font-bold">Using our services</h2>
          <p className="py-2 text-slate-600">
        ...
        <div className="pt-1">
          ...
          <p className="py-2 text-slate-600">
            ...
            our Services, you agree that Space can use such data in accordance
        ...
        <div className="pt-1">
          ...
          <p className="py-2 text-slate-600">
            ...
            business listing you have added to Space Maps). Some Services may
